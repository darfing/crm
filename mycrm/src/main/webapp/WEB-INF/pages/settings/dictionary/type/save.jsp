...
<script type="text/javascript">
	$(function () {
		...
		$("#sava").click(function () {
			...
			$.ajax({
				url: 'settings/dictionary/saveCreatedDictionaryType.do',
				data: {
					code: code,
					name: name,
	...
	function check(){
		var code = $("#code").val();
		$.ajax({
			url:"settings/dictionary/type/checkCodeIsExist.do/" + code,
			type: "get",
			success: function (data) {
				if(data.code=="1") {
					$("#msg").text("");
	...
	<form class="form-horizontal" role="form">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="code" style="width: 200%;" onblur="check()"><span id="msg" style="color: red"></span>
			</div>
		</div>
