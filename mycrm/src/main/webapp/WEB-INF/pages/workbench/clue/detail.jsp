	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$("#saveBundActivityBtn").click(function () {
				...
				ids+="id=${clue.id}";//activityId=xxxx&activityId=xxxx&....&activityId=xxxx&clueId=xxxxx
				//发送请求
				$.ajax({
			...
			$("#convertClueBtn").click(function () {
				...
				var id='${clue.id}';
				//发送同步请求
				window.location.href="workbench/clue/toConvert.do/"+id;
			});
		});
